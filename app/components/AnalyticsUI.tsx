            ...
            <div className="p-4 w-full min-h-full flex flex-col">
                ...
                <div id="content-section" className="mt-4">
                    <div id="booking-section-header" className="flex flex-row justify-between items-center">
                        ...
                        <h1 className="font-semibold text-sm flex flex-row justify-center items-center">25<span><p className="font-light text-xs ml-0.5">(-25 since last week)</p></span></h1>
                    </div>
                    <div id="top-bookings" className="w-full p-2 min-h-32 bg-secondary mt-4 rounded-2xl flex flex-col">
                        ...
                        <div className="grid grid-cols-[65%_1fr] gap-4">
                            <p>#1 CLC CNMX1001</p>
                            <p className="place-self-end">10 bookings</p>
                        </div>
                        <div className="grid grid-cols-[65%_1fr] gap-4">
                            <p>#2 FCI CQAR2007</p>
                            <p className="place-self-end">2 bookings</p>
                        </div>
                        <div className="grid grid-cols-[65%_1fr] gap-4">
                            <p>#3 FAIE CQAR2035</p>
                            <p className="place-self-end">1 booking</p>
                        </div>
                    </div>
                    ...
                    <div id="booking-section-header" className="flex flex-row justify-between items-center">
                        ...
                        <h1 className="font-semibold text-sm flex flex-row justify-center items-center">67<span><p className="font-light text-xs ml-0.5">(+25 since last week)</p></span></h1>
                    </div>
                    <div id="top-bookings" className="w-full p-2 min-h-32 bg-secondary mt-4 rounded-2xl flex flex-col">
                        <h1 className="font-semibold">Top 3 Most Reported Venues</h1>
                        <div className="grid grid-cols-[65%_1fr] gap-4">
                            <p>#1 CLC CNMX1001</p>
                            <p className="place-self-end">10 reports</p>
                        </div>
                        <div className="grid grid-cols-[65%_1fr] gap-4">
                            <p>#2 FCI CQAR2007</p>
                            <p className="place-self-end">2 reports</p>
                        </div>
                        <div className="grid grid-cols-[65%_1fr] gap-4">
                            <p>#3 FAIE CQAR2035</p>
                            <p className="place-self-end">1 reports</p>
                        </div>
                    </div>
                </div>
