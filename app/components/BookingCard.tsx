            ...
            <div className="flex flex-col gap-1 w-full p-4 bg-white/50 bg-blur-md rounded-lg">
                <div className="flex flex-col gap-1 p-4">
                    ...
                    <div className="flex flex-row justify-end mt-2">
                        ...
                        <Button className="!w-fit !rounded-3xl !text-white !py-2 !px-4 rounded-md !hover:bg-red-600 !transition-colors ml-2" buttonText="Report Fault" onClick={() => {router.push(`/faulty-report/${booking.resource.resource_id}`)}} />
                    </div>
                </div>
            </div>
    );
